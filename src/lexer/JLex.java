 ...
 *  
 *  Changes:
 *  - class "Main" renamed to "JLex"
 *  - output file is <inputFilename>.java, 
 *  	where inputFilename.lex is the first argument
 *  
 */
...
public class JLex {
	...
	public static void main(String arg[]) throws java.io.IOException {
		...
		if (arg.length < 1) {
			System.out.println("Usage: lexer.JLex <filename>");
			return;
		}
...
class CLexGen {
	...
	CLexGen(String filename) throws java.io.FileNotFoundException,
		...
		String outFilename = filename.endsWith(".lex") ? filename
				.substring(0,filename.length() - 4) : filename;

		/* Open output stream. */
		m_outstream = new java.io.PrintWriter(new java.io.BufferedWriter(
				new java.io.FileWriter(outFilename + ".java")));
		if (null == m_outstream) {
