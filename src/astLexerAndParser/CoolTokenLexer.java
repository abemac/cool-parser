...
public class CoolTokenLexer implements java_cup.runtime.Scanner {
	...
	private final int yy_state_dtrans[] = { 0, 90, 166, 167, 168, 169, 175,
			176, 177 };
		...
		while (true) {
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case 53: {
						throw new Error(
								"unmatched text in token lexer; integer constant expected");
					}
					case -54:
						break;
					case 54: {
					...
					case 55: {
						throw new Error(
								"unmatched text in token lexer; boolean constant expected");
					}
					case -56:
						break;
					case 56: {
						...
						case STR:
							return new Symbol(TokenConstants.STR_CONST,
									AbstractTable.stringtable.addString(buf
											.toString()));
						case ERR:
							return new Symbol(TokenConstants.ERROR, buf
									.toString());
						case YYINITIAL:
							filename = AbstractTable.stringtable.addString(buf
									.toString());
							break;
						default:
